...
function getAnyProxyHome() {
    const home = process.env.ROOT_DATA_DIR || path.join(getUserHome(), '/.anyproxy/');
...
module.exports.contentType = function (filepath) {
    return _mime().contentType(path.extname(filepath));
};
...
module.exports.getFreePort = function () {
    return new Promise(_getFreePort_promise);
}

function _getFreePort_promise(resolve, reject) {
